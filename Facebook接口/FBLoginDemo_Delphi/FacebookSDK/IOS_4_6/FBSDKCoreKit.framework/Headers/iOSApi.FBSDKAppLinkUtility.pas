...
unit iOSApi.FBSDKAppLinkUtility;
...
type
	...
	(^FBSDKDeferredAppLinkHandler)(NSURL *url, NSError *error)=void;
	...
	(^FBSDKDeferredAppInviteHandler)(NSURL *url)=void;
	...
	['{8906381D-152C-448D-BAE7-BB3C5A151DF1}']
	...
	['{5E409520-AA54-474C-9BBC-4BAB2172FFCD}']
		{+} procedure fetchDeferredAppLink(handler:FBSDKDeferredAppLinkHandler);cdecl;
		{+} function fetchDeferredAppInvite(handler:FBSDKDeferredAppInviteHandler):Boolean;cdecl;
		{+} function appInvitePromotionCodeFromURL(url:NSURL{*}):NSString{*};cdecl;
	end;
	
	TFBSDKAppLinkUtility=class(TOCGenericImport<FBSDKAppLinkUtilityClass,FBSDKAppLinkUtility>)
	end;
{$ENDIF}
