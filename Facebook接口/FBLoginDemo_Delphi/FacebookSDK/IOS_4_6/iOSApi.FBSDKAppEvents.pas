...
type
	...
	FBSDKAppEventsFlushBehavior=Integer;
...
//	  }
	...
	['{CF5E1239-7631-4D56-92FB-57D64157A4F9}']
	...
	['{18A82A60-4639-4A19-958B-1D886817B8DD}']
		{+} procedure logEvent(eventName:NSString{*});cdecl;
		[MethodName('logEvent:valueToSum:')]
		{+} procedure logEventvalueToSum(eventName:NSString{*};valueToSum:double);cdecl;
		[MethodName('logEvent:parameters:')]
		{+} procedure logEventparameters(eventName:NSString{*};parameters:PNSDictionary{*});cdecl;
		[MethodName('logEvent:valueToSum:parameters:')]
		{+} procedure logEventvalueToSumparameters(eventName:NSString{*};valueToSum:double;parameters:PNSDictionary{*});cdecl;
		[MethodName('logEvent:valueToSum:parameters:accessToken:')]
//		{+} procedure logEventvalueToSumparametersaccessToken(eventName:NSString{*};valueToSum:NSNumber{*};parameters:PNSDictionary{*};accessToken:FBSDKAccessToken{*});cdecl;
		[MethodName('logPurchase:currency:')]
		{+} procedure logPurchasecurrency(purchaseAmount:double;currency:NSString{*});cdecl;
		[MethodName('logPurchase:currency:parameters:')]
		{+} procedure logPurchasecurrencyparameters(purchaseAmount:double;currency:NSString{*};parameters:PNSDictionary{*});cdecl;
		[MethodName('logPurchase:currency:parameters:accessToken:')]
//		{+} procedure logPurchasecurrencyparametersaccessToken(purchaseAmount:double;currency:NSString{*};parameters:PNSDictionary{*};accessToken:FBSDKAccessToken{*});cdecl;
		{+} procedure logPushNotificationOpen(payload:PNSDictionary{*});cdecl;
		[MethodName('logPushNotificationOpen:action:')]
		{+} procedure logPushNotificationOpenaction(payload:PNSDictionary{*};action:NSString{*});cdecl;
		{+} procedure activateApp;cdecl;
		{+} procedure setPushNotificationsDeviceToken(deviceToken:NSData{*});cdecl;
		{+} function flushBehavior:FBSDKAppEventsFlushBehavior;cdecl;
		{+} procedure setFlushBehavior(flushBehavior:FBSDKAppEventsFlushBehavior);cdecl;
		{+} procedure setLoggingOverrideAppID(appID:NSString{*});cdecl;
		{+} function loggingOverrideAppID:NSString{*};cdecl;
		{+} procedure flush;cdecl;
//		{+} function requestForCustomAudienceThirdPartyIDWithAccessToken(accessToken:FBSDKAccessToken{*}):FBSDKGraphRequest{*};cdecl;
		{+} procedure setUserID(userID:NSString{*});cdecl;
		{+} function userID:NSString{*};cdecl;
//		[MethodName('updateUserProperties:handler:')]
//		{+} procedure updateUserPropertieshandler(properties:PNSDictionary{*};handler:FBSDKGraphRequestHandler);cdecl;
	end;
	
	TFBSDKAppEvents=class(TOCGenericImport<FBSDKAppEventsClass,FBSDKAppEvents>)
	end;
{$ENDIF}
