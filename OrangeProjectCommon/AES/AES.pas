...
//  Padding_Zero: Boolean = False; OnProcessProc: TOnProcessProc = nil; ProcessProc: TProcessProc = nil); overload;
//procedure EncryptAESStreamECB(Source: TStream; Count: cardinal;
...
//  InitVectorStr: string = ''; Padding_Zero: Boolean = False; CBCMode: Boolean = True;
...
//  OnProcessProc: TOnProcessProc = nil; ProcessProc: TProcessProc = nil);
//
//function AESEncryptStr(Value, Key: string; StrEncoding: TEncoding = nil;
...
//}
//
//function AESDecryptStr(Str: TBytes; Key: string;
...
//
//function AESEncryptStrToHex(Value, Key: string; StrEncoding: TEncoding = nil;
//  KeyEncoding: TEncoding = nil;
//  KeyBit: TKeyBit = kb128;
//  InitVectorStr: string = ''; Padding_Zero: Boolean = False; CBCMode: Boolean = True;
//  ValueCRLFMode: TCRLFMode = rlCRLF;
...
//
//function AESDecryptStrFromHex(StrHex, Key: string;
//  ResultEncoding: TEncoding = nil; KeyEncoding: TEncoding = nil;
//  KeyBit: TKeyBit = kb128;
//  InitVectorStr: string = ''; Padding_Zero: Boolean = False; CBCMode: Boolean = True;
//  ResultCRLFMode: TCRLFMode = rlCRLF;
...
//procedure EncryptAESStreamECB(Source: TStream; Count: cardinal;
//  const Key: TAESKey128; Dest: TStream;
//  Padding_Zero: Boolean = False; OnProcessProc: TOnProcessProc = nil; ProcessProc: TProcessProc = nil);
//var
//  ExpandedKey: TAESExpandedKey128;
//begin
//  ExpandAESKeyForEncryption(Key, ExpandedKey);
//  EncryptAESStreamECB(Source, Count, ExpandedKey, Dest, Padding_Zero, OnProcessProc, ProcessProc);
//end;
//
//procedure EncryptAESStreamECB(Source: TStream; Count: cardinal;
//  const Key: TAESKey192; Dest: TStream;
...
//      exit;
//  end;
//  if (Count = 0) and (not Padding_Zero) then
//  begin
...
//    else
//    begin
//      FillChar(TempIn[Count], SizeOf(TempIn) - Count, PaddingCount);
//    end;
//    EncryptAES(TempIn, ExpandedKey, TempOut);
//    Done := Dest.Write(TempOut, SizeOf(TempOut));
//    if Done < SizeOf(TempOut) then
...
//  DecryptAESStreamECB(Source, Count, ExpandedKey, Dest, Padding_Zero, OnProcessProc, ProcessProc);
//end;
//
//procedure DecryptAESStreamECB(Source: TStream; Count: cardinal;
//  const ExpandedKey: TAESExpandedKey128; Dest: TStream;
...
//        if PaddingCount > 16 then PaddingCount := 0;
//        if PaddingCount > 0 then PaddingCount := 16 - PaddingCount;
//      end;
//    end;
...
//begin
//  ExpandAESKeyForEncryption(Key, ExpandedKey);
//  EncryptAESStreamCBC(Source, Count, ExpandedKey, InitVector, Dest, Padding_Zero, OnProcessProc, ProcessProc);
//end;
//
//procedure EncryptAESStreamCBC(Source: TStream; Count: cardinal;
//  const ExpandedKey: TAESExpandedKey128;  const InitVector: TAESBuffer;
...
//begin
//  ExpandAESKeyForDecryption(Key, ExpandedKey);
//  DecryptAESStreamCBC(Source, Count, ExpandedKey, InitVector, Dest, Padding_Zero, OnProcessProc, ProcessProc);
//end;
//
//procedure DecryptAESStreamCBC(Source: TStream; Count: cardinal;
//  const ExpandedKey: TAESExpandedKey128;  const InitVector: TAESBuffer;
...
//    Padding_Zero, CBCMode, ValueCRLFMode,
...
//    InitVectorStr, Padding_Zero, CBCMode, ResultCRLFMode,
//    KeyCRLFMode, OnProcessProc, ProcessProc);
//end;
//
//function AESEncryptStr(Value, Key: string; StrEncoding: TEncoding = nil;
...
//        Padding_Zero, CBCMode, KeyCRLFMode,
...
//  ivBytes := TEncoding.ASCII.GetBytes(InitVectorStr);
//  J := 0;
//  for I := Low(InitVector) to High(InitVector) do
//  begin
//    if J < Length(ivBytes) then
//    begin
//      InitVector[I] := ivBytes[J];
//    end
//    else
//    begin
//      InitVector[I] := 0;
...
//    if CBCMode then
//    begin
//      EncryptAESStreamCBC(InStream, ByteCount, AESKey128, InitVector, OutStream, Padding_Zero, OnProcessProc, ProcessProc);
//    end
//    else
//    begin
//      EncryptAESStreamECB(InStream, ByteCount, AESKey128, OutStream, Padding_Zero, OnProcessProc, ProcessProc);
//    end;
//  end;
//  { --  192 位密匙最大长度为 24 个字符 -- }
...
//    if CBCMode then
//    begin
//      EncryptAESStreamCBC(InStream, ByteCount, AESKey192, InitVector, OutStream, Padding_Zero, OnProcessProc, ProcessProc);
//    end
//    else
//    begin
//      EncryptAESStreamECB(InStream, ByteCount, AESKey192, OutStream, Padding_Zero, OnProcessProc, ProcessProc);
//    end;
//  end;
//  { --  256 位密匙最大长度为 32 个字符 -- }
...
//    if CBCMode then
//    begin
//      EncryptAESStreamCBC(InStream, ByteCount, AESKey256, InitVector, OutStream, Padding_Zero, OnProcessProc, ProcessProc);
//    end
//    else
//    begin
//      EncryptAESStreamECB(InStream, ByteCount, AESKey256, OutStream, Padding_Zero, OnProcessProc, ProcessProc);
//    end;
//  end;
//end;
//
...
//    if CBCMode then
//    begin
//      DecryptAESStreamCBC(InStream, ByteCount, AESKey128, InitVector, OutStream, Padding_Zero, OnProcessProc, ProcessProc);
//    end
//    else
//    begin
//      DecryptAESStreamECB(InStream, ByteCount, AESKey128, OutStream, Padding_Zero, OnProcessProc, ProcessProc);
//    end;
//  end;
//  { --  192 位密匙最大长度为 24 个字符 -- }
//  if KeyBit = kb192 then
...
//    if CBCMode then
//    begin
//      DecryptAESStreamCBC(InStream, ByteCount, AESKey192, InitVector, OutStream, Padding_Zero, OnProcessProc, ProcessProc);
//    end
//    else
//    begin
//      DecryptAESStreamECB(InStream, ByteCount, AESKey192, OutStream, Padding_Zero, OnProcessProc, ProcessProc);
//    end;
//  end;
//  { --  256 位密匙最大长度为 32 个字符 -- }
//  if KeyBit = kb256 then
...
//    if CBCMode then
//    begin
//      DecryptAESStreamCBC(InStream, ByteCount, AESKey256, InitVector, OutStream, Padding_Zero, OnProcessProc, ProcessProc);
//    end
//    else
//    begin
//      DecryptAESStreamECB(InStream, ByteCount, AESKey256, OutStream, Padding_Zero, OnProcessProc, ProcessProc);
//    end;
//  end;
//  TestByte := 0;
//  SizeToDelete := 0;
...
function AESEncryptBuffer128(dest: PByte; destLen: PLongint;
   source: PByte; Count: Longint; const AESKey: string): Integer;
function AESDecryptBuffer128(dest: PByte; destLen: PLongint;
   source: PByte; Count: Longint; const AESKey: string): Integer;
...
function AESEncryptStrHex(const strIn: string; const AESKey: string): string;
function AESDecyptStrHex(const strIn: string; const AESKey: string): string;

procedure AESEncryptStream(const StreamIn, StreamOut: TMemoryStream; const AESKey: string);
procedure AESEncryptStream192(const StreamIn, StreamOut: TMemoryStream; const AESKey: string);
procedure AESEncryptStream256(const StreamIn, StreamOut: TMemoryStream; const AESKey: string);
procedure AESDecyptStream(const StreamIn, StreamOut: TMemoryStream; const AESKey: string);
procedure AESDecyptStream256(const StreamIn, StreamOut: TMemoryStream; const AESKey: string);
...
begin
  ...
  len := Min(SizeOf(Key), Length(AESKey));
  for i := 0 to len - 1 do Key[i] := Ord(AESKey[i+1]);
  ...
  begin
    ...
    EncryptAES(TempIn, ExpandedKey, TempOut);
    Move(TempOut,PByte(dest)^, SizeOf(TempOut));
    Dec(Count, SizeOf(TAESBuffer));
...
begin
  ...
  while Count >= SizeOf(TAESBuffer) do
  begin
    Move(PByte(source+destLen^)^, TempIn, SizeOf(TempIn));
    DecryptAES(TempIn, ExpandedKey, TempOut);
    Move(TempOut, PByte(dest+destLen^)^, SizeOf(TempOut));
    Dec(Count, SizeOf(TAESBuffer));
    Inc(destLen^,SizeOf(TAESBuffer));
  end;
...
begin
  ...
  try
    ...
    Source.Position := 0;
    Move(PChar(strIn)^, Source.Memory^, SizeOf(Char) * (Length(strIn) + 1));
