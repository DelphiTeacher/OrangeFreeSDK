...
begin
  ...
  x := dm.widthPixels;
  y := dm.heightPixels;
  ScreenInches := Sqrt((x * x / dm.xdpi / dm.xdpi) + (y * y / dm.ydpi / dm.ydpi));
  Result := ScreenInches >= MiniScreenInches;
end;
{$ENDIF}
...
begin
  ...
  Sm := nil;
  SmNative := SharedActivityContext.getSystemService(TJContext.JavaClass.STORAGE_SERVICE);
