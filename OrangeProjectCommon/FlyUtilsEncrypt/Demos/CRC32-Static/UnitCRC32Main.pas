...
uses
  FlyUtils.CRC32, FlyUtils.CnXXX.Common;
...
begin
  ...
  begin
    Memo2.Text := GetCrc32StrToHex(Memo1.Text.Trim, TEncoding.ANSI, rlCRLF, 8, Process);
  end;
  if RadioButton_Wide.IsChecked then
  begin
    Memo2.Text := GetCrc32StrToHex(Memo1.Text.Trim,  TEncoding.Unicode, rlCRLF, 8, Process);
  end;

  if RadioButton_UTF8.IsChecked then
  begin
    Memo2.Text := GetCrc32StrToHex(Memo1.Text.Trim, TEncoding.UTF8, rlCRLF, 8, Process);
  end;
end;
