...
uses
  FlyUtils.CnSM3, FlyUtils.CnXXX.Common;
...
begin
  ...
  begin
    Memo2.Text := SM3StringToHex(Memo1.Text.Trim, TEncoding.ANSI, rlCRLF,
      CheckBoxHmac.IsChecked, Edit1.Text.Trim, TEncoding.ANSI, rlCRLF, Process);
  end;
  if RadioButton_Wide.IsChecked then
  begin
    Memo2.Text := SM3StringToHex(Memo1.Text.Trim,  TEncoding.Unicode, rlCRLF,
      CheckBoxHmac.IsChecked, Edit1.Text.Trim, TEncoding.ANSI, rlCRLF, Process);
  end;

  if RadioButton_UTF8.IsChecked then
  begin
    Memo2.Text := SM3StringToHex(Memo1.Text.Trim, TEncoding.UTF8, rlCRLF,
      CheckBoxHmac.IsChecked, Edit1.Text.Trim, TEncoding.ANSI, rlCRLF, Process);
  end;
end;
