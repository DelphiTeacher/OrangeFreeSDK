object FrameListItemStyle_CaptionCenter_CloseBtnRight_TopBorderSelected: TFrameListItemStyle_CaptionCenter_CloseBtnRight_TopBorderSelected
  Left = 0
  Top = 0
  Width = 799
  Height = 382
  ...
  object ItemDesignerPanel: TSkinWinItemDesignerPanel
    ...
    SelfOwnMaterial.BackColor.BorderEadges = [beLeft, beTop, beBottom]
    ...
    SelfOwnMaterial.BackColor.DrawEffectSetting.PushedEffect.BorderWidth = 3
    ...
    object pnlSelectedBorderTop: TSkinWinPanel
      Left = 0
      Top = 0
      Width = 177
      Height = 3
