...
//  System.Classes,
  ...
  FMX.Surfaces, FMX.Graphics, FMX.Controls;
...
begin
  Event := TEvent.Create;
  //begin
  if CheckUIThread then
  begin
    Result := Func(); //like CallResult := Func();
    exit;
  end;
  //end
  try
...
begin
  ...
  if CheckUIThread then
  begin
    Result := Func(Arg); //like CallResult := Func();
    exit;
  end;
  //end
  try
...
begin
  ...
  if CheckUIThread then
  begin
    Proc(Arg1, Arg2); // same as the code below CallInUIThread
    exit;
  end;
  //end
  CallInUIThread(
...
begin
  ...
  if CheckUIThread then
  begin
    Result := Func(Arg1,Arg2); //like CallResult := Func();
    exit;
  end;
  //end
  try
...
begin
  ...
  if CheckUIThread then
  begin
    Proc(Arg); // same as the code below CallInUIThread
    exit;
  end;
  //end
  CallInUIThread(
...
begin
  ...
  if CheckUIThread then
  begin
    Proc(Arg1,Arg2,Arg3); // same as the code below CallInUIThread
    exit;
  end;
  //end
  CallInUIThread(
