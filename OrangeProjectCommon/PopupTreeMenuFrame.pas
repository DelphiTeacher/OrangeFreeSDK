...
//procedure TFramePopupTreeMenu.DoFilter;
//var
//  I: Integer;
//  AFilter:String;
//begin
...
//procedure TFramePopupTreeMenu.DoListDataController_LoadDataToUIEnd(Sender: TObject);
//begin
...
procedure TFramePopupTreeMenu.edtFilterChangeTracking(Sender: TObject);
begin
end;

//procedure TFramePopupTreeMenu.FilterSelectedCategory;
//var
//  I: Integer;
...
//procedure TFramePopupTreeMenu.Init(const ACaption: String;
//                                AOnGetDataJsonEvent: TTimerTaskNotify;
//                                ADataJsonArrayKey: String;
//                                AItemCaptionBindingFieldName:String;
//                                AItemStyle:String='';
...
//end;
//
//procedure TFramePopupTreeMenu.Init(
//  const ACaption: String;
//  AMenuCaptions: array of String;
//  AItemStyle: String;
//  AIsShowFilter:Boolean;
...
//procedure TFramePopupTreeMenu.SetProp(AFontHorzAlign, AWidth: Integer);
//begin
//  //标题FontHorzAlign
...
//
//  //设置菜单框宽度  0不修改
//  if (AWidth<>0) AND (AWidth<>Self.pnlPopupTreeMenu.Width) then
//  begin
//    Self.pnlPopupTreeMenu.Width:=AWidth;
//  end;
//end;
...
//procedure TFramePopupTreeMenu.InitCategory(
//        //分类
//        ACategoryCaptions:Array of String;
//        ACategoryNames:Array of String;
//        //判断列表项属于哪个分类的事件
