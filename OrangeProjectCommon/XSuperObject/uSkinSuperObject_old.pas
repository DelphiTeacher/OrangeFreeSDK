...
//    property Offset: Integer read GetOffset;
    function GetEnumerator: TJSONObject.TEnumerator;//TSuperEnumerator<IJSONPair>;
...
function TSuperObject.GetEnumerator: TJSONObject.TEnumerator;//TSuperEnumerator<IJSONPair>;
begin
//  Result.Index := -1;
