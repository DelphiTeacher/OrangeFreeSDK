//https://quality.embarcadero.com/browse/RSP-15598
//Fix by [重庆]老新手(371889755)
...
//Fix by [重庆]老新手(371889755)
//fix or add By Flying Wang.
  if IsSupportedInterface and (Target is TControl) then
    FCameraService.TakePhoto(TargetControl, GetParamsPhotoQuery)
  else
    FCameraService.TakePhoto(nil, GetParamsPhotoQuery);
end;
