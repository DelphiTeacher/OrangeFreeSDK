...
(*　　　　　　　　　　　　　　　　　　　　　　　　　　　　*)
(* ****************************************************** *)
//https://quality.embarcadero.com/browse/RSP-17792
//https://quality.embarcadero.com/browse/RSP-17793
...
//fix by flying wang.
    if not FStaysPressed or not PointInObjectLocal(X, Y) then
      RestoreButtonState;
  end;
  inherited;
end;
...
//fix by [绍兴]黑夜杀手(281309196) and Michael B
//https://quality.embarcadero.com/browse/RSP-18155
//fix or add by flying wang.
  if FChangingState or IsExpanded then
    Result := inherited
  else
