(* ****************************************************** *)
(*　　　　　　　　　　　　　　　　　　　　　　　　　　　　*)
(*　　　　修改：爱吃猪头肉 & Flying Wang 2015-05-04　　　 *)
(*　　　　　　　　上面的版权声明请不要移除。　　　　　　　*)
(*　　　　　　　　　　　　　　　　　　　　　　　　　　　　*)
(*　　　    　　　　　禁止发布到城通网盘。　　　　  　　　*)
(*　　　　　　　　　　　　　　　　　　　　　　　　　　　　*)
...
(*　　　　　　　　　　　　　　　　　　　　　　　　　　　　*)
(* ****************************************************** *)
//https://quality.embarcadero.com/browse/RSP-12698
  ...
  if Target.Children <> nil then
    ...
    begin
      ...
      begin
        ...
        while TAnimation(Target.Children[I]).Running and (not Application.Terminated) do
        begin
...
begin
  ...
  try
    ...
    Animation.Start;
    //Fix by Flying Wang & 爱吃猪头肉。
    while Animation.FRunning and (not Application.Terminated) do
    begin
      Application.ProcessMessages;
      Sleep(0);
    end;
