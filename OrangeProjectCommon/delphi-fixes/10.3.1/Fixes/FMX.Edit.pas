//https://quality.embarcadero.com/browse/RSP-21876
...
//fix by Alex Guzmán add by flying wang.
  if (FClipboardSvc <> nil) and not FClipboardSvc.GetClipboard.ToString.IsEmpty then
  begin
    OldText := Model.Text;
