...
var
  ...
  begin
    ...
    begin
      ...
      begin
        var VKObj: IVirtualKeyboardControl := nil;
...
begin
  ...
  //Fix or Add By 爱吃猪头肉
  CurrStatusBarPixelHeight := Inset.Top;
  //Fix or Add By 爱吃猪头肉
  var IsFullScreen: Boolean := GetIsFullScreen(True);
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        CurrStatusBarPixelHeight := GetStatusBarPixelHeight - Trunc(FWindowService.Scale);
      end;
    end;
  end;
  ...
  if IsFullScreen or ForceNoStatusBar then
    CurrStatusBarPixelHeight := 0;
  CurrStatusBarFmxHeight := CurrStatusBarPixelHeight / FWindowService.Scale;
  FWindowService.FStatusBarHeight := CurrStatusBarFmxHeight;
end;
