(* ****************************************************** *)
(*　　　　　　　　　　　　　　　　　　　　　　　　　　　　*)
(*　　　　修改：爱吃猪头肉 & Flying Wang 2017-04-10　　　 *)
(*　　　　　　　　上面的版权声明请不要移除。　　　　　　　*)
(*　　　　　　　　　　　　　　　　　　　　　　　　　　　　*)
(*　　　    　　　　　禁止发布到城通网盘。　　　　  　　　*)
(*　　　　　　　　　　　　　　　　　　　　　　　　　　　　*)
...
(* ****************************************************** *)
//修改默认的 字体。
//https://quality.embarcadero.com/browse/RSP-20650
...
procedure TPlatformWin.UpdateMenuItem(const AItem: IItemsContainer; AChange: TMenuItemChanges);
  ...
  begin
    Result := 0;
    ParentMenuItem := AMenuItem.ParentMenuItem;
    if ParentMenuItem <> nil then
      Result := (ParentMenuItem as INativeControl).Handle
    else
    begin
      MainMenu := AMenuItem.MainMenu;
      if MainMenu <> nil then
        Result := (MainMenu as INativeControl).Handle;
    end;
  end;
  ...
  begin
    ...
    if Bitmap <> 0 then
      ...
      RemoveBitmapFromMenu(ParentHandle, MenuItemHandle, FHMenuMap);
  end;
...
begin
  if TOSVersion.Check(6) then
    ...
    Result := 'Tahoma';
  var hFont: HGDIOBJ := GetStockObject(DEFAULT_GUI_FONT);
  var lf: LOGFONT;
  if Winapi.Windows.GetObject(hFont, SizeOf(LOGFONT), Addr(lf)) <> 0 then
  begin
