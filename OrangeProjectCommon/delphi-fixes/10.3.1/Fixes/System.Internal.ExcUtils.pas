(* ****************************************************** *)
(*　　　　　　　　　　　　　　　　　　　　　　　　　　　　*)
(*　　　　修改：爱吃猪头肉 & Flying Wang 2017-12-22　　　 *)
(*　　　　　　　　上面的版权声明请不要移除。　　　　　　　*)
(*　　　　　　　　　　　　　　　　　　　　　　　　　　　　*)
(*　　　    　　　　　禁止发布到城通网盘。　　　　  　　　*)
(*　　　　　　　　　　　　　　　　　　　　　　　　　　　　*)
(*　　仅支持 RAD10.3.0(10.3 RTM)，其他版本请自行修改　　　*)
(*　　　　　　　　　　　　　　　　　　　　　　　　　　　　*)
(* ****************************************************** *)
...
function GetExceptionObject(ExceptionAddress: NativeUInt; AccessAddress: NativeUInt; ErrorCode: LongWord): Exception;
//fix by flying wang.
{$IF Defined(DEBUG) and Defined(ANDROID)}
var
  EMsg: string;
  M: TMarshaller;
begin
  //fix by flying wang.
  EMsg := 'FMX Exception: ErrorCode: ' + ErrorCode.ToString + '';
  LOGE(M.AsUtf8(EMsg).ToPointer);
{$ELSE}
begin
{$ENDIF}
...
begin
  //fix by flying wang.
  EMsg := 'FMX Exception: JNI: ' + JNIExceptionClassName + ': ' + Msg;
  LOGE(M.AsUtf8(EMsg).ToPointer);
{$ELSE}
begin
{$ENDIF}
