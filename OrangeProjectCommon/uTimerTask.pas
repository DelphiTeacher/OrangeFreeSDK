      ...
      try
          ...
          begin
              try
                ...
                on E:Exception do
                begin
                  uBaseLog.HandleException(E,'OrangeUICommon','uTimerTask','ATimerTask.FOnExecute');
                end;
              end;
          end;
      finally
...
//              uBaseLog.HandleException(nil,'OrangeUICommon','uTimerTask','ATimerTask.FOnExecuteEnd Begin TaskName:'+ATimerTask.TaskName);
              try
                  try
                    ...
                    on E:Exception do
                    begin
                      uBaseLog.HandleException(E,'OrangeUICommon','uTimerTask','ATimerTask.FOnExecuteEnd');
                    end;
                  end;
              finally
