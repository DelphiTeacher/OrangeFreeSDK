...
//    function verifyCredentials(P1: JBoolean; P2: JBoolean; P3: JBoolean): JCall; cdecl;
      function verifyCredentials(P1: JBoolean;P2: JBoolean; P3: JBoolean):JUser;cdecl;
    { Property }
  end;
...
//    function deserialize(P1: JString): JObject; cdecl; overload;
  ...
  JTwitterLoginButtonClass = interface(JViewClass)//JObjectClass)
  ...
  JTwitterLoginButton = interface(JView)//Object)
